...
(function () {
    ...
    const seed = {
        ...
        fin_accounts: [
            {
                ...
                pendingTotal: -141.67,
                pendingCount: 3,
                balance_date: today.toISOString(),
            },
            {
                id: 'demo-savings',
                name: 'Demo Savings',
        ...
        bank_last_fetch_iso: today.toISOString(),
        ...
        ast_energy: JSON.stringify({ value: 6, updatedAt: Date.now() }),
        ast_settings: JSON.stringify({ theme: 'dark', version: 2 }),
        ast_version: '2',
    ...
    console.log('[DEMO MODE] Seed data loaded. ' + Object.keys(seed).length + ' keys.');
})();
